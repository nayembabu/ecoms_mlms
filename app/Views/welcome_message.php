...
<head>
    ...
    <link rel="icon" href="inc/assets/images/favicon/4.png" type="image/x-icon">
...
<body class="theme-color-2 bg-effect">
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <a href="index.html" class="web-logo nav-logo">
                                <img src="inc/assets/images/logo/3.png" class="img-fluid blur-up lazyload" alt="">
                            </a>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li>
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="inc/assets/images/vegetable/product/1.png"
                                                    ...
                                                    <li>
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="inc/assets/images/vegetable/product/2.png"
                                                                    class="blur-up lazyload" alt="">
                                                            </a>
                    ...
                    <div class="main-nav">
                                ...
                                <ul class="category-list">
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/vegetable.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/cup.svg" alt="">
                                            <h6>Beverages</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/meats.svg" alt="">
                                            <h6>Meats & Seafood</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/breakfast.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/frozen.svg" alt="">
                                            <h6>Frozen Foods</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/biscuit.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="inc/assets/svg/1/grocery.svg" alt="">
                                                        ...
                                                        <div class="dropdown-column m-0">
                                                            <div class="menu-img-banner">
                                                                <a class="text-title" href="product-circle.html">
                                                                    <img src="inc/assets/images/mega-menu.png"
                                                                        alt="banner">
                                                                </a>
                                                            </div>
                                                        </div>
                        ...
                        <div class="right-nav">
                            <div class="nav-number">
                                <img src="inc/assets/images/icon/music.png" class="img-fluid blur-up lazyload" alt="">
                                <span>(123) 456 7890</span>
                            </div>
                            <a href="javascript:void(0)" class="btn theme-bg-color ms-3 fire-button"
                                data-bs-toggle="modal" data-bs-target="#deal-box">
                                <div class="fire">
                                    <img src="inc/assets/images/icon/hot-sale.png" class="img-fluid" alt="">
                                </div>
                                <span>Hot Deals</span>
                            </a>
                        </div>
            ...
            <div class="row g-4">
                <div class="col-xxl-6 col-md-8">
                    <div class="home-contain h-100">
                        <img src="inc/assets/images/veg-3/home/1.png" class="img-fluid bg-img blur-up lazyload" alt="">
                ...
                <div class="col-xxl-3 col-md-4 ratio_medium d-md-block d-none">
                    <div class="home-contain home-small h-100">
                        <div class="h-100">
                            <img src="inc/assets/images/veg-3/home/2.png" class="img-fluid bg-img blur-up lazyload"
                                alt="">
                        </div>
                ...
                <div class="col-xxl-3 ratio_65 d-xxl-block d-none">
                    <div class="row g-3">
                        <div class="col-xxl-12 col-sm-6">
                            <div class="home-contain">
                                <a href="shop-left-sidebar.html">
                                    <img src="inc/assets/images/veg-3/home/3.png"
                        ...
                        <div class="col-xxl-12 col-sm-6">
                            <div class="home-contain">
                                <a href="shop-left-sidebar.html">
                                    <img src="inc/assets/images/veg-3/home/4.png"
                                        class="img-fluid bg-img blur-up lazyload" alt="">
                                </a>
                    ...
                    <div class="category-slider arrow-slider">
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn">
                                <a href="shop-left-sidebar.html" class="circle-1">
                                    <img src="inc/assets/images/veg-3/category/1.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.05s">
                                <a href="shop-left-sidebar.html" class="circle-2">
                                    <img src="inc/assets/images/veg-3/category/2.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.1s">
                                <a href="shop-left-sidebar.html" class="circle-3">
                                    <img src="inc/assets/images/veg-3/category/3.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                                    <h6>Food Cupboard</h6>
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.15s">
                                <a href="shop-left-sidebar.html" class="circle-4">
                                    <img src="inc/assets/images/veg-3/category/4.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                                    <h6>Dals & Pulses</h6>
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.2s">
                                <a href="shop-left-sidebar.html" class="circle-4">
                                    <img src="inc/assets/images/veg-3/category/5.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.25s">
                                <a href="shop-left-sidebar.html" class="circle-1">
                                    <img src="inc/assets/images/veg-3/category/6.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.3s">
                                <a href="shop-left-sidebar.html" class="circle-2">
                                    <img src="inc/assets/images/veg-3/category/7.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                        ...
                        <div>
                            <div class="shop-category-box border-0 wow fadeIn" data-wow-delay="0.35s">
                                <a href="shop-left-sidebar.html" class="circle-3">
                                    <img src="inc/assets/images/veg-3/category/8.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                                <div class="category-name">
                                    <h6>Instant Mixes</h6>
                    ...
                    <div class="three-slider arrow-slider ratio_65">
                        <div>
                            <div class="offer-banner hover-effect">
                                <img src="inc/assets/images/veg-3/value/1.png" class="img-fluid bg-img blur-up lazyload"
                                    alt="">
                        ...
                        <div>
                            <div class="offer-banner hover-effect">
                                <img src="inc/assets/images/veg-3/value/2.png" class="img-fluid bg-img blur-up lazyload"
                                    alt="">
                                <div class="banner-detail">
                        ...
                        <div>
                            <div class="offer-banner hover-effect">
                                <img src="inc/assets/images/veg-3/value/3.png" class="img-fluid bg-img blur-up lazyload"
                                    alt="">
                                <div class="banner-detail">
                    ...
                    <div class="three-slider-1 arrow-slider">
                        <div>
                            <div class="deal-box wow fadeInUp">
                                <a href="shop-left-sidebar.html" class="category-image order-sm-2">
                                    <img src="inc/assets/images/veg-3/cate1/1.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="deal-box wow fadeInUp" data-wow-delay="0.05s">
                                <a href="shop-left-sidebar.html" class="category-image order-sm-2">
                                    <img src="inc/assets/images/veg-3/cate1/2.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="deal-box wow fadeInUp" data-wow-delay="0.1s">
                                <a href="shop-left-sidebar.html" class="category-image order-sm-2">
                                    <img src="inc/assets/images/veg-3/cate1/3.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                        ...
                        <div>
                            <div class="deal-box wow fadeInUp" data-wow-delay="0.15s">
                                <div class="category-image order-sm-2">
                                    <img src="inc/assets/images/veg-3/cate1/1.png" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.05s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/3.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/5.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.15s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/6.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/7.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/9.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/11.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.35s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/12.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/13.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.45s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/15.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/17.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.55s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/18.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/2.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/4.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/10.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/8.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/14.png" class="img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="inc/assets/images/veg-3/cate1/16.png" class="img-fluid" alt="">
                                    </a>
            ...
            <div class="row gy-xl-0 gy-3">
                <div class="col-xl-6">
                    <div class="banner-contain-3 hover-effect">
                        <img src="inc/assets/images/veg-3/banner/1.png" class="bg-img img-fluid" alt="">
                        <div
                ...
                <div class="col-xl-6">
                    <div class="banner-contain-3 hover-effect">
                        <img src="inc/assets/images/veg-3/banner/2.png" class="bg-img img-fluid" alt="">
                                    ...
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/1.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/2.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/3.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                ...
                                <div>
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/4.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/5.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/6.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                ...
                                <div>
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/7.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/8.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 pb-1 wow fadeInUp" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/9.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                ...
                                <div>
                                    <div class="row gy-sm-4 gy-3">
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/10.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/11.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
                                        ...
                                        <div class="col-12">
                                            <div class="product-box-4 wow fadeInUp pb-1" data-wow-delay="0.1s">
                                                <a href="shop-left-sidebar.html" class="product-image">
                                                    <img src="inc/assets/images/veg-3/pro1/12.png" class="img-fluid"
                                                        alt="">
                                                </a>
                                                <div class="product-details">
                                                    <ul class="rating">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-contain-3 section-b-space section-t-space hover-effect">
                        <img src="inc/assets/images/veg-3/banner/3.png" class="img-fluid bg-img" alt="">
            ...
            <div class="slider-3 arrow-slider">
                    ...
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="inc/assets/images/veg-3/blog/1.jpg" class="img-fluid bg-img" alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="inc/assets/images/veg-3/blog/2.jpg" class="img-fluid bg-img" alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="inc/assets/images/veg-3/blog/3.jpg" class="img-fluid bg-img" alt="">
                            </a>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="newsletter-box hover-effect">
                        <img src="inc/assets/images/veg-3/shape/background.png" class="img-fluid bg-img" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-4 col-xl-5 d-xl-block d-none">
                                <div class="shape-box">
                                    <img src="inc/assets/images/veg-3/shape/basket.png" alt="" class="img-fluid image-1">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-md-4 gy-sm-5 gy-2">
                    <div class="col-xxl-3 col-xl-4 col-sm-6">
                        <a href="index.html" class="foot-logo">
                            <img src="inc/assets/images/logo/3.png" class="img-fluid" alt="">
                        </a>
                            ...
                            <ul>
                                <li>
                                    <a href="https://play.google.com/store/apps" target="_blank">
                                        <img src="inc/assets/images/playstore.svg" class="blur-up lazyload" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.apple.com/in/app-store/" target="_blank">
                                        <img src="inc/assets/images/appstore.svg" class="blur-up lazyload" alt="">
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="right-footer">
                    <ul class="payment-box">
                        <li>
                            <img src="inc/assets/images/icon/paymant/visa.png" alt="">
                        </li>
                        <li>
                            <img src="inc/assets/images/icon/paymant/discover.png" alt="">
                        </li>
                        <li>
                            <img src="inc/assets/images/icon/paymant/american.png" alt="">
                        </li>
                        <li>
                            <img src="inc/assets/images/icon/paymant/master-card.png" alt="">
                        </li>
                        <li>
                            <img src="inc/assets/images/icon/paymant/giro-pay.png" alt="">
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="inc/assets/images/product/category/1.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="inc/assets/images/vegetable/product/10.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="inc/assets/images/vegetable/product/11.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="inc/assets/images/vegetable/product/12.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="inc/assets/images/vegetable/product/13.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
    ...
    <div class="cookie-bar-box">
        <div class="cookie-box">
            <div class="cookie-image">
                <img src="inc/assets/images/cookie-bar.png" class="blur-up lazyload" alt="">
                <h2>Cookies!</h2>
            </div>
    ...
    <div class="item-section">
        ...
        <ul class="items-image">
            <li>
                <img src="inc/assets/images/veg-3/cate1/1.png" alt="">
            </li>
            <li>
                <img src="inc/assets/images/veg-3/cate1/2.png" alt="">
            </li>
            <li>+3</li>
        </ul>
    ...
    <!-- latest jquery-->
    <script src="inc/assets/js/jquery-3.6.0.min.js"></script>
    ...
    <!-- Quantity Js -->
    <script src="inc/assets/js/quantity.js"></script>

    <!-- Timer Js -->
    <script src="inc/assets/js/timer1.js"></script>
    <script src="inc/assets/js/timer2.js"></script>
    <script src="inc/assets/js/timer3.js"></script>
    <script src="inc/assets/js/timer4.js"></script>
    ...
    <!-- theme setting js -->
    <script src="inc/assets/js/theme-setting.js"></script>
</body>
                        ...
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="inc/img/slider_pic/<?= $day; ?>.jpg" class="bg-img blur-up lazyload"
                                        alt="">
