...
.pb-2  { right: 8%; top: 6%;   background: linear-gradient(90deg,#ffb347,#ff7e5f); animation: floatY 5.6s ease-in-out infinite; animation-delay: .6s; }
...
.pb-9  { right: 22%; bottom: 34%;background: linear-gradient(90deg,#198754,#2ecc71); animation: floatY 6.8s ease-in-out infinite; animation-delay: .1s; }
...
.pb-12 { left: 32%; bottom: 12%; background: linear-gradient(90deg,#7c3aed,#6d28d9); animation: floatY 6.6s ease-in-out infinite; animation-delay: .2s; }
...
.pb-16 { right: 28%; bottom: 22%; background: linear-gradient(90deg,#fd7e14,#f97316); animation: floatY 6.9s ease-in-out infinite; animation-delay: .6s; }

/* additional bubbles (user requested more and more) */
...
<div class="profit-bubbles" aria-hidden="true">
    ...
    <div class="profit-bubble pb-10"><i class="fa-solid fa-user-plus"></i><span>+8,400 Users</span></div>
    <div class="profit-bubble pb-11"><i class="fa-solid fa-bullseye"></i><span>Conversion +11%</span></div>
    ...
    <div class="profit-bubble pb-22"><i class="fa-solid fa-people-group"></i><span>Community 22K+</span></div>
    ...
    <div class="profit-bubble pb-25"><i class="fa-solid fa-chart-area"></i><span>Traffic +140%</span></div>

    <!-- micro / accent bubbles -->
    <div class="profit-bubble pb-26"><i class="fa-solid fa-ticket"></i><span>Flash Sale</span></div>
    <div class="profit-bubble pb-27"><i class="fa-solid fa-heart"></i><span>Customer Love</span></div>
    <div class="profit-bubble pb-28"><i class="fa-solid fa-rocket"></i><span>Fast Delivery</span></div>

    <!-- more taka-specific highlights -->
    <div class="profit-bubble pb-29" style="left:10%; top:60%; background: linear-gradient(90deg,#046c4e,#0ea5a4);"><i class="fa-solid fa-wallet"></i><span><span class="taka">৳</span>72,400 Payouts</span></div>
    <div class="profit-bubble pb-30" style="right:12%; bottom:60%; background: linear-gradient(90deg,#b45309,#f59e0b);"><i class="fa-solid fa-money-bill-transfer"></i><span><span class="taka">৳</span>18,650 Transfers</span></div>
</div>
