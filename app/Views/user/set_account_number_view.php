                ...
                <div class="card border-0 shadow-lg animate__animated animate__fadeIn">
                    ...
                    <div class="card-body p-4">
                        ...
                        <?php if ($my_info->user_withdraw_nos && $my_info->user_withdraw_method && $my_info->payments_names) { ?>
                            <div class="alert alert-success animate__animated animate__fadeInDown text-center " role="alert">
                                <i class="fas fa-info-circle me-2"></i>Your current withdrawal account method is: <strong><?php echo esc($my_info->user_withdraw_method); ?></strong><br>
                                <i class="fas fa-info-circle me-2"></i>Your current withdrawal account number is: <strong><?php echo esc($my_info->user_withdraw_nos); ?></strong><br>
                                <i class="fas fa-info-circle me-2"></i>Your current payment name is: <strong><?php echo esc($my_info->payments_names); ?></strong>
                            </div>
                        <?php }else { ?>
                            <form class="needs-validation" novalidate method="post" action="user/set_account_number_action">
                                ...
                                <div class="mb-4 animate__animated animate__fadeInRight">
                                    ...
                                    <input type="text" name="account_number" class="form-control form-control-lg" pattern="[0-9]{8,}" required placeholder="Enter your account number" value="<?= $my_info->user_withdraw_nos; ?>" >
                                ...
                                <div class="mb-4 animate__animated animate__fadeInLeft">
                                    ...
                                    placeholder="Enter account holder's name" value="<?= $my_info->payments_names; ?>">
