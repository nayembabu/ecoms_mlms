                        ...
                        html_card += `<div class="col-md-4">
                                        <div class="card shadow-sm single_user_info " user_info_id="${rsp[l].user_full_info_idd}" style="cursor: pointer; " >
                                            <div class="card-body text-center">
                                                ...
                                                <p class="card-text mb-1"><strong>ID:</strong> <span class="badge ${(rsp[l].sts == 0 ? 'bg-secondary' : 'bg-success')}">${rsp[l].user_reffer_code_times}</span></p>
                                            </div>
                                        </div>
                                        </div>`;
                        }
                        ...
                        `<div class="card-body d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="user_detail_s" user_id="${resp.users_data.user_full_info_idd}" >
                                    ...
                                    <span class="badge ${(resp.users_data.sts == 0 ? 'bg-secondary' : 'bg-success')}">${(resp.users_data.sts == 1 ? 'Active' : resp.users_data.sts == 2 ? 'Suspend' : resp.users_data.sts == 0 ? 'Inactive' : 'Error')}</span>
                            ...
                            <div>
                                <div class="btn btn-sm bg-danger text-white action-btn"><i class="bi bi-lock"></i>Suspend</div>
                                <div class="btn btn-sm ${(resp.users_data.sts == 1 ? 'bg-secondary' : 'bg-success')} text-white action-btn ${(resp.users_data.sts == 1 ? 'accountInactive' : 'accountActivate')}">${(resp.users_data.sts == 1 ? '<i class="fas fa-times-circle"></i>' : '<i class="fas fa-check-circle"></i>')} ${(resp.users_data.sts == 1 ? 'Inactive' : 'Active')}</div>
                            </div>
                            <div>
